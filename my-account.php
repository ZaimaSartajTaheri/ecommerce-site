...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $previous_email;?>" readonly>
					  </div>
					  <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn update-button">Update</button>
					</form>
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
			    ...
			    ?>
					  <button type="submit" name="submit" class="btn update-button">Change </button>
					</form> 
