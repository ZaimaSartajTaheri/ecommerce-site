                ...
                <?php echo $_SESSION['errmsg']="";?>
		         ...
		         <div class="radio outer-xs">
		          <a href="forgot-password.php" class="forgot-password pull-right">Forgot your Password?</a>
	  	         ...
	  	         <button type="submit" class="btn login-button checkout-page-button" name="login">Login</button>
	            </form>					
               </div>
<!-- Sign-in -->
...
<!-- create a new account -->
               <div class="col-md-6 col-sm-6 create-new-account">
	            ...
	            <form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();">
                 <div class="form-group">
	    	       ...
	    	       <input type="text" class="form-control unicase-form-control text-input" id="fullname" name="fullname" value="<?php if(isset($name)) echo $name;?>">
	  	         </div>
                <?php
                ...
                ?>
		         ...
		         <div class="form-group">
	    	       ...
	    	       <input type="email" class="form-control unicase-form-control text-input" id="email" name="email" value="<?php
              ...
              ?>">
                ...
                ?>
                 ...
                 <div class="form-group">
	    	      ...
	    	      <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" value="<?php
        ...
        if(isset($contact_no)) echo $contact_no;
              ...
              <span><b>I agree to your terms and conditions</b></span>
                 ...
                 <button type="submit" name="submit" class="btn signup-button checkout-page-button mb-3" id="submit">Sign Up</button>
	            </form>
